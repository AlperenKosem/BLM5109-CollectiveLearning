...
# https://github.com/yogeshgajjar/CNN-CIFAR-10-image-classification/blob/master/LeNet-5_PyTorch/CIFAR10.ipynb

# Cihaz kullanılabilirse GPU'yu kullan, yoksa CPU'yu kullan
device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")

file_name = "subset_splits_final.pkl"
...
num_epochs = 16
batch_size = 32
train_loader = DataLoader(subset_splits[0], batch_size=batch_size, shuffle=True)
...
seed = 7
torch.manual_seed(seed) #başlangıç noktası tanımlanıyor.

model = SimpleCNN()

model_weights_path = 'weights/w0_weights.pth'
