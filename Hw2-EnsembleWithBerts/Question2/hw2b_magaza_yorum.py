...
df_train=pd.read_csv("hw2_b/magaza_yorum/magaza_yorumlari_duygu_analizi_train.csv", encoding = "utf-16")
print(df_train.head())
...
f = open("hw2b_final_report_for_big_bert_magaza_yorum.txt", "a")
