...
model_bag0 = pickle.load(open('small_bert_beyaz_perde/small_bert_model_from_bag0_bs32_e5_lr2e-05.pkl', 'rb'))
model_bag1 = pickle.load(open('small_bert_beyaz_perde/small_bert_model_from_bag1_bs16_e10_lr5e-05.pkl', 'rb'))
model_bag2 = pickle.load(open('small_bert_beyaz_perde/small_bert_model_from_bag2_bs32_e15_lr3e-05.pkl', 'rb'))
model_bag3 = pickle.load(open('small_bert_beyaz_perde/small_bert_model_from_bag3_bs32_e15_lr2e-05.pkl', 'rb'))
model_bag4 = pickle.load(open('small_bert_beyaz_perde/small_bert_model_from_bag4_bs32_e6_lr4e-05.pkl', 'rb'))
...
pickle.dump(all_predictions, open(f'all_predictions_small_bert.pkl', 'wb'))
pickle.dump(all_true_labels, open(f'all_true_labels_small_bert.pkl', 'wb'))
