...
df_train=pd.read_csv("hw2_a/imdb_turkish/train.csv",index_col=[0],encoding="windows-1252")
df_test=pd.read_csv("hw2_a/imdb_turkish/test.csv",index_col=[0],encoding="windows-1252")
...
for X_sampled, y_sampled in zip(bagged_train, bagged_label):
    ...
    config = AutoConfig.from_pretrained(
            "dbmdz/bert-base-turkish-uncased",num_labels=2)
    # Load BertForSequenceClassification, the pretrained BERT model with a single 
    # linear classification layer on top. 
    model = AutoModelForSequenceClassification.from_pretrained(
        "dbmdz/bert-base-turkish-uncased",config=config)
